    ...
    >
      ...
      >
        ...
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
          "With the development of today's technology, metaverse is a very
          useful technology for today's work, or can be called web 3.0 by using
          blockchain technology. You can use it in anything."
        </p>
      </motion.div>
